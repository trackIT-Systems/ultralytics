...
class Albumentations:
    ...
    def __init__(self, hyp: SimpleNamespace=None, p=1.0, transforms: list | None = None): # type: ignore
...
def v8_transforms(dataset, imgsz: int, hyp: IterableSimpleNamespace, stretch: bool = False):
    ...
    return Compose(
        [
            ...
            Albumentations(hyp=hyp, p=1.0, transforms=getattr(hyp, "augmentations", None)),
